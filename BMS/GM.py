...
class GenericMethodsMixin:
    ...
    def put(self, request, pk, *args, **kwargs):
        ...
        print("in FGeneric put method awe are ")
        # print(request.thisUser, object1.user)
        # if request.thisUser != object1.user:
        #     return Response(
    ...
    def delete(self, request, pk, *args, **kwargs):
        ...
        # Delete User or Recruiter 
        # if request.user != data.created_by  or request.user != data.user:
        #     return Response(
        #         {"message : Unauthorized"}, status=status.HTTP_401_UNAUTHORIZED
        #     )
        if data:
